...
from DL.keras.model import train_val, test, testOnePair
...
phase = 'testOnePair'  # train or test or predict
train_data, val_data, test_data, size_of_sample = get_divided_data(path=path, val_size=val_size, ts_size=test_size,
...
elif phase == 'testOnePair':
    folder = r'C:\Users\user\Documents\Research\FeatureCorrespondenes\data\dense\experiment'
    testOnePair(folder=folder, checkpoint=checkpoint, size_of_sample=size_of_sample)
